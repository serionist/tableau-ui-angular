export abstract class UsedIcons {
    ...
    builtInIcons: string[] = ['check', 'clear', 'close', 'info', 'error', 'keyboard_arrow_up', 'keyboard_arrow_right', 'keyboard_arrow_down', 'keyboard_arrow_left', 'swap_vert', 'arrow_downward', 'arrow_upward'];
